...
import NatarajaSceneClient from '../app/components/NatarajaSceneClient'
  ...
  return (
    <>
      ...
      >
        ...
        >
          Our AI listens to Bharatanatyam performances and identifies tala
          patterns in real time — bridging ancient rhythm with modern
          intelligence.
        </p>
        <button
          style={{
