...
let cachedModelPromise: Promise<THREE.Object3D> | null = null

function getCachedNatarajaModel(): Promise<THREE.Object3D> {
...
export default function NatarajaScene() {
  ...
  useEffect(() => {
    ...
    getCachedNatarajaModel().then((baseModel) => {
      ...
      console.error('Failed to load nataraja.glb', error)
    })
